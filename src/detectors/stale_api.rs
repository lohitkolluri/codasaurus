...
/// Detect stale/outdated API usage patterns that are commonly
/// generated by AI models trained on older code.
///
/// Checks for:
/// - Deprecated method calls
/// - Known API migrations (e.g. old library APIs)
/// - Patterns that were popular in older training data
...
static STALE_PATTERNS: Lazy<Vec<StalePattern>> = Lazy::new(|| {
    vec![
