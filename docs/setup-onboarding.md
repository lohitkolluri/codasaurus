...
6. Create the owner email/password (min 8 characters). This account is the instance **superuser** (bootstrap owner). There is no email reset yet. Store the password safely. Invite teammates later from **Team** in the sidebar.
